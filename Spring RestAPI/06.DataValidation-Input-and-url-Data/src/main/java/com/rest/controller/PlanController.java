...
public class PlanController {
    ...
    public ResponseEntity<List<PlanDTO>> fetchPlan() throws NoSuchPlanException {
        List<PlanDTO> planDTO=planService.fetchPlans();
    ...
    public ResponseEntity<List<PlanDTO>> plansLocalRate(@MatrixVariable(pathVar = "query") Map<String,List<Integer>> map) throws NoSuchPlanException {
        ...
        List<PlanDTO> planDTO = planService.plansLocalRate(localRates);
        return new ResponseEntity<>(planDTO,HttpStatus.OK);
    }
}
